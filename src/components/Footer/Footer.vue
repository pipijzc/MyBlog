  ...
  <div>
    <div class="footBack footBackQian">
      ...
      <div class="fcontainer">
        ...
        <p>
          奔跑于
          <a href="https://www.aliyun.com/?spm=a2c49.11131515.0.0.5Z9AkR" target="_blank">阿里云</a>服务器. 源码
          <a href="https://github.com/pipijzc" target="_blank">Github</a>
        </p>
        <p>
          © 2020
          <a href="#">Vector-Blog</a>. 由
          <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动.
          <a href="http://beian.miit.gov.cn/" target="_blank">粤ICP备20016927号-1</a>
        </p>
        <p>
          <span>For Dream.</span>
        </p>
...
export default {
  ...
  methods: {
    runTime: function() {
      //运行倒计时
      var that = this;
      var oldTime = new Date("2020/02/29 00:00:00");
